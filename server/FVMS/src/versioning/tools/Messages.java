...
public enum Messages {
	Update_failed("Required update failed due to tehnical reasons"), File_added(
			...
			"Trash is empty"), Permission_set("Permission set"), Permission_settingFailed(
			"Setting permission failed"), File_boundToProject(
			"Existent file was bound to project"), Permission_alreadySet(
			"Permission was already set for this folder)");
